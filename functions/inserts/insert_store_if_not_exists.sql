...
BEGIN v_store_row := select_store_by_name_and_address(p_name, p_address);
...
AND v_store_row.website IS NULL THEN v_store_row := update_store_website(v_store_row.store_id, p_website);
END IF;
RETURN v_store_row;
END;
$$ LANGUAGE plpgsql;